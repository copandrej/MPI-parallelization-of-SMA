...
/* Include files */
#include "_coder_runProgram_api.h"
#include "_coder_runProgram_mex.h"
...
void runProgram_atexit(void)
{
  ...
  runProgram_xil_terminate();
  runProgram_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/* End of code generation (_coder_runProgram_api.c) */
