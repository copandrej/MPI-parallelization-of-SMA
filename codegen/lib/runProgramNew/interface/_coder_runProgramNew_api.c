...
void runProgramNew_atexit(void)
{
  ...
  runProgramNew_xil_terminate();
  runProgramNew_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/* End of code generation (_coder_runProgramNew_api.c) */
